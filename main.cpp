...
{
	CreateWindow("Button", "one", WS_CHILD | WS_VISIBLE, 50, 50, 100, 25, hw, (HMENU)id_button1, 0, 0);
	CreateWindow("Button", "two", WS_CHILD | WS_VISIBLE, 50, 100, 100, 25, hw, (HMENU)id_button2, 0, 0);
}
