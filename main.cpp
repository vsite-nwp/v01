...
void OnCreate(HWND hw) {
	...
	CreateWindow("BUTTON", "Button1", WS_CHILD | WS_VISIBLE, 150, 150, 100, 50, hw, (HMENU)id_button1, 0, 0);
	CreateWindow("BUTTON", "Button2", WS_CHILD | WS_VISIBLE, 150, 220, 100, 50, hw, (HMENU)id_button2, 0, 0);
}
void OnCommand(HWND hw, int id) {
	// TODO: show message box with text depending on which button was pressed

	if (id = id_button1)
		MessageBox(NULL, "Window message", "message", MB_OK | MB_ICONEXCLAMATION);
}
