...
void OnCreate(HWND hw) {
	...
	CreateWindow("BUTTON", "one", WS_CHILD | WS_VISIBLE, 100, 100, 100, 50, hw, NULL, NULL, 0, NULL);
	CreateWindow("BUTTON", "two", WS_CHILD | WS_VISIBLE, 100, 200, 100, 50, hw, NULL, NULL, 0, NULL);
}
