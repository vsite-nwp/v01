...
void OnCreate(HWND hw) {
	...
	HWND btn1 = CreateWindow("BUTTON","one",WS_CHILD | WS_VISIBLE,200,80,100,100,hw,(HMENU)id_button1,0,NULL);

	HWND btn2;
	btn2= CreateWindow("BUTTON","two",WS_CHILD | WS_VISIBLE,200,190,100,100,hw,	(HMENU)id_button2,0,NULL);
}
...
void OnCommand(HWND hw, int id) {
	...
	(id == id_button1) ? MessageBox(hw, "one", "button", MB_ICONWARNING | MB_OK) : MessageBox(hw, "two", "button", MB_ICONWARNING | MB_OK);
}
