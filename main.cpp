...
void on_create(HWND hw) 
{
	...
	CreateWindow("BUTTON", "one", WS_CHILD | WS_VISIBLE, 200, 200, 200, 30, hw, (HMENU)id_button1, 0, 0);
	CreateWindow("BUTTON", "two", WS_CHILD | WS_VISIBLE, 200, 260, 200, 30, hw, (HMENU)id_button2, 0, 0);
}
