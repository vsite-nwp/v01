...
void OnCreate(HWND hw) {
	CreateWindow("BUTTON", "one", WS_CHILDWINDOW | WS_VISIBLE, 80, 50, 60, 25, hw, (HMENU)id_button1, 0, 0);
	CreateWindow("BUTTON", "two", WS_CHILDWINDOW | WS_VISIBLE, 80, 80, 60, 25, hw, (HMENU)id_button2, 0, 0);
}
