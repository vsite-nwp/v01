...
void OnCreate(HWND hw) {
	...
	HWND hwnd1 = CreateWindow("BUTTON", "one", WS_CHILD | WS_VISIBLE,
		50, 50, 100, 50, hw, NULL, NULL, NULL);
	HWND hwnd2 = CreateWindow("BUTTON", "two", WS_CHILD | WS_VISIBLE,
		50, 150, 100, 50, hw, NULL, NULL, NULL);
}
