...
void OnCreate(HWND hw) {
	...
	CreateWindow("BUTTON", "ONE", WS_CHILD | WS_VISIBLE, 100, 30, 90, 30, hw, (HMENU)id_button1, 0, 0);
	CreateWindow("BUTTON", "TWO", WS_CHILD | WS_VISIBLE, 100, 100, 90, 30, hw, (HMENU)id_button2, 0, 0);
}
...
int RegisterMyClass(HINSTANCE hInstance, char* className)
{
	...
	wc.hbrBackground = CreateSolidBrush(COLORREF RGB(0, 200, 200)); // TODO: replace with cyan background
